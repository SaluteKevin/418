          ...
          <div class="col">
            <div class="card ho" style="width: 24rem">
              ...
              <ul class="list-group list-group-flush ho">
                <li
                  class="list-group-item white-text"
                  style="background-color: #050e1f"
                >
                  ชอบเขียนโค้ด
                </li>
              </ul>
              ...
              <ul class="list-group list-group-flush ho">
                <li
                  class="list-group-item white-text"
                  style="background-color: #11306b"
                >
                  ขี้เกียจกลับบ้าน เดินทางนาน
                </li>
              </ul>
            </div>
          </div>
          ...
          <div class="col">
            <div class="card ho" style="width: 24rem">
              ...
              <ul class="list-group list-group-flush ho">
                <li
                  class="list-group-item white-text"
                  style="background-color: #103b3b"
                >
                  อยาก ต่อ model RG ให้เสร็จ
                </li>
              </ul>
              <ul class="list-group list-group-flush ho">
                <li
                  class="list-group-item white-text"
                  style="background-color: #1a6161"
                >
                  ชอบกิน
                </li>
              </ul>
